...
public:
	...
	*/
	//특정 상태일 때는 이걸 먹도록 하게.
	enum STAGE_STATE { STATE_STATE_IDLE, STATE_STATE_MOVE, STAGE_STATE_JUMP, STAGE_STATE_BATTLE, STATE_STATE_EX, STAGE_STATE_DEAD,STAGE_STATE_EVENT, STAGE_STATE_END };
public:
