...
HRESULT CLoader_Start::Loading_ForLogoLevel()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Model_EnemyTSS_PowerLoader_PMC"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../../Resources/Models/AnimModels/Enemies/EnemyTSS_PowerLoader_PMC/", "EnemyTSS_PowerLoader_PMC.fbx",
			rotMat))))
		return E_FAIL;

	/* For.Prototype_Component_Texture_Default */
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_EnemyTSS_PowerLoader_PMC_Diffuse"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../Resources/Models/AnimModels/Enemies/EnemyTSS_PowerLoader_PMC/EnemyTSS_PowerLoader_PMC.png"), 1))))
		return E_FAIL;
