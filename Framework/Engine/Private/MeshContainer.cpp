...
HRESULT CMeshContainer::Ready_VertexBuffer_NonAnim(const aiMesh* pAIMesh)
{
...
CMeshContainer * CMeshContainer::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, CModel::MODELTYPE eType, const aiMesh * pAIMesh)
{
